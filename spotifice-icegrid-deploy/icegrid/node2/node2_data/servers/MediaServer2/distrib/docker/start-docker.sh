...
echo "1. Generando checksums para IcePatch2..."
cd "$SCRIPT_DIR/.."
icepatch2calc . 2>/dev/null || echo "   (icepatch2calc no disponible localmente, se generará en el contenedor)"
cd "$SCRIPT_DIR"

echo "2. Construyendo imagen base..."
$COMPOSE_CMD build --quiet

echo "3. Iniciando contenedores..."
$COMPOSE_CMD up -d

echo "4. Esperando a que el sistema se inicie..."
...
echo "  - IcePatch2 Server:  Distribución de archivos activa"
